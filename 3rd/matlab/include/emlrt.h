 ...
 */
#define EMLRT_VERSION_R2025A 0x2025A
#define EMLRT_VERSION_INFO   EMLRT_VERSION_R2025A
...
EXTERN_C LIBEMLRT_API void emlrtSetAllProperties(emlrtConstCTX,
                                                 ...
                                                 const mxArray* const* propertyValues);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtAssertMATLABThread(emlrtConstCTX aTLS, const emlrtMCInfo* aLoc);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtImportVsFiArrayR2024a(emlrtConstCTX aTLS,
...
/*
 * MATLAB INTERNAL USE ONLY
 */
EXTERN_C LIBEMLRT_API void emlrtSetVsFiSizesR2024a(emlrtConstCTX aTLS,
                                                   const mxArray* aFi,
                                                   uint32_T aNDims,
                                                   const int32_T* aVDims,
                                                   const boolean_T* aDynamic,
                                                   int32_T* aOutSizes);
...
EXTERN_C LIBEMLRT_API void emlrtCaptureInputs(const mxArray* const* data,
                                              int32_T numInputs,
                                              void* aFcnPtr);
